    ...
    <div className="bg-surface border-t border-border">
      <div className="p-4 flex items-start justify-between border-b border-border/50">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Highest operational priority identified by System Engine</p>
        </div>
        <div className="flex items-center gap-2 bg-secondary text-foreground px-2 py-1 rounded text-xs font-semibold border border-border">
      ...
      <div className="px-4 py-3 bg-secondary/20 border-t border-border/50">
        <p className="text-[11px] text-muted-foreground font-mono uppercase tracking-wider mb-2">Decision Factors</p>
      ...
      <div className="p-3 bg-base flex items-center justify-end gap-3">
